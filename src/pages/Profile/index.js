...
function Profile() {
    const userData = {
        ...
        email: 'hung.truongthuan@hcmut.edu.vn',
        phone: '0903557962',
    };
    ...
    return (
        <div className="mt-[65px] md:ml-[70px] lg:px-[220px] md:px-[80px] px-[20px] py-[50px] min-h-[800px]">
            ...
            <div className="flex flex-col md:flex-row md:gap-[50px] gap-[10px] items-start">
                <p className="text-[20px] font-bold md:max-w-[200px]">Thông tin tài khoản</p>
                <div className="flex-1 flex flex-col gap-[22px] w-full md:w-auto">
                    ...
                    <div>
                        <p className="text-[14px] font-semibold mb-[10px] w-full">Email</p>
                        <input
                            value={email}
                    ...
                    <div>
                        <p className="text-[14px] font-semibold mb-[10px] w-full">Số điện thoại</p>
                        <input
                            value={phone}
            ...
            <div className="flex flex-col md:flex-row md:gap-[50px] gap-[10px] items-start my-[40px]">
                <p className="text-[20px] font-bold md:max-w-[200px]">Đổi mật khẩu</p>
                <div className="flex-1 flex flex-col gap-[22px] w-full md:w-auto">
                    <div>
